 ...
 ******************************************************************************/
 ...
 package edu.princeton.cs.algs4.introcs;
...
import edu.princeton.cs.algs4.StdOut;
 ...
 public class ST<Key extends Comparable<Key>, Value> implements Iterable<Key> {
      ...
      *
      * @param  valid_pair the key
      * @return {@code true} if this symbol table contains {@code key} and
      *         {@code false} otherwise
      * @throws IllegalArgumentException if {@code key} is {@code null}
      */
     public boolean contains(long valid_pair) {
         if (valid_pair == null) throw new IllegalArgumentException("calls contains() with null key");
         return st.containsKey(valid_pair);
     }
